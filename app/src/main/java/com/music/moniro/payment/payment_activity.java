...
public class payment_activity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(payment_activity.this);
